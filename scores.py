...
class ScoreBoard:
    ...
    def show_scores(self):
        ...
        lives_text = self.font.render(f"lives: X{self.lives}", True, self.color)

        score_text_rect = score_text.get_rect(topleft=(self.x, 10))
        high_score_text_rect = high_score_text.get_rect(topleft=(self.x, 26))
        lives_text_rect = lives_text.get_rect(topleft=(self.x, 42))
    ...
    def game_over(self):
        game_over_color = 'red'
        game_over_font = pg.font.SysFont("Comic Sans", 30)
    ...
    def success(self):
        ...
        game_success_font = pg.font.SysFont("Times New Roman", 30)
        game_success_text = game_success_font.render(f"Wow, you are amazing, press '0' to restart.", True, game_success_color)
        game_success_rect = game_success_text.get_rect(topleft=(25, 300))
        self.screen.blit(game_success_text, (25, 300))
        self.record_high_score()
